...
public class AccountPageController extends AbstractSearchPageController
{
	...
	protected Set<NewsLetterOptionData> createNewsLetterOptionsData(String [] codes) {
		Set<NewsLetterOptionData> newsLetterOptionDataSet = new HashSet<>();
		for (String code: codes) {
			NewsLetterOptionData newsLetterOptionData = new NewsLetterOptionData();
			newsLetterOptionData.setCode(code);
